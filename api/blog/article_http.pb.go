...
func NewArticleHandler(srv ArticleHandler, opts ...http1.HandleOption) http.Handler {
	...
	r.HandleFunc("/api.blog.Article/CreateArticle", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.blog.Article/UpdateArticle", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.blog.Article/DeleteArticle", func(w http.ResponseWriter, r *http.Request) {
	...
	r.HandleFunc("/api.blog.Article/GetArticle", func(w http.ResponseWriter, r *http.Request) {
