...
func (m *ArticleMutation) SetType(i int64) {
	m._type = &i
	m.add_type = nil
}

// GetType returns the value of the "type" field in the mutation.
func (m *ArticleMutation) GetType() (r int64, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
// If the Article object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ArticleMutation) OldType(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ArticleMutation) AddType(i int64) {
	if m.add_type != nil {
		*m.add_type += i
	} else {
		m.add_type = &i
...
func (m *ArticleMutation) AddedType() (r int64, exists bool) {
	v := m.add_type
	if v == nil {
		return
	}
...
func (m *ArticleMutation) SetCityID(i int64) {
	m.city_id = &i
	m.addcity_id = nil
}

// CityID returns the value of the "city_id" field in the mutation.
func (m *ArticleMutation) CityID() (r int64, exists bool) {
	v := m.city_id
	if v == nil {
		return
	}
...
// OldCityID returns the old "city_id" field's value of the Article entity.
// If the Article object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ArticleMutation) OldCityID(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ArticleMutation) AddCityID(i int64) {
	if m.addcity_id != nil {
		*m.addcity_id += i
	} else {
		m.addcity_id = &i
...
func (m *ArticleMutation) AddedCityID() (r int64, exists bool) {
	v := m.addcity_id
	if v == nil {
		return
	}
...
func (m *ArticleMutation) ResetCityID() {
	m.city_id = nil
	m.addcity_id = nil
}
